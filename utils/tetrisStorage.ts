...
const GAME_TYPE = 'tetris';
const LOCAL_BEST_KEY = 'tetris_best';
const LOCAL_GAMES_KEY = 'tetris_total_games_v1';
...
export async function loadTetrisBest(): Promise<number> {
...
export async function recordTetrisGame(score: number): Promise<void> {
  const user = await getCurrentUser();
